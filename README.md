Projeto API Rest que simula um cadastro para vacinação da população, aonde é possível cadastrar a pessoa, validar os esus dados pessoais, e também contabilizar a sua vacina, 
